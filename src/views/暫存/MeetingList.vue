<template>
  <div class="meeting_list h-full w-full p-5">
    ...
    <div class="flex-col space-y-10 rounded-xl bg-white p-10 shadow-6">
      ...
      <test @sand-form="sand" rulesOption="false" :tagsValue="tags" type="outline"></test>
      <test @sand-form="sand" rulesOption="false" :tagsValue="tags2" tagsInput="false" type="primary"></test>
      <!--<test @sand-form="sand" rulesOption="false" :tagsValue="tags2"></test>-->
      <!--表格-->
