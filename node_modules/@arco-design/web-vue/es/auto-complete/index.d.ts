...
declare const AutoComplete: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "disabled" | "allowClear" | "defaultValue" | "modelValue" | "data" | "strict" | "filterOption">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "change", value: string) => void) & ((event: "clear", ev: Event) => void) & ((event: "update:modelValue", value: string) => void) & ((event: "select", value: string) => void) & ((event: "search", value: string) => void);
        $el: any;
